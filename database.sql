...
UPDATE accounts SET account_balance=10.00 WHERE account_balance=0.00 OR transactions_attempted=0;
SELECT * FROM accounts WHERE account_balance=10.00
...
INSERT INTO accounts (username, city, transactions_completed, transactions_attempted, account_balance) VALUES ('micah', 'minneapolis', 2, 2, 125000);
